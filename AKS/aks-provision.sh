...
export AKS_SUBNET_ID="/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/${RG_SHARED}/providers/Microsoft.Network/virtualNetworks/${PROJ_VNET_NAME}/subnets/${AKS_SUBNET_NAME}"

# echo $AKS_SUBNET_ID
# '/subscriptions/xxxx-xxxx-xxxx-xxxx-xxxx/resourceGroups/xxxx/providers/Microsoft.Network/virtualNetworks/xxxx/subnets/xxxx'
